...
let btnVendas = document.getAnimations('vendas');
...
//btnVendas.addEventListener('click',venda,false); - não funcionando
...
function planilha(e){
    // instrução do tableToExcel
    TableToExcel.convert(document.getElementById('pedido'));
}